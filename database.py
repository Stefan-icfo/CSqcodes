...
DATABASE_LOCATION = ".\Data\Raw_data\CD12_B5_F4v13.db"
...
BACKUP_DATABASE_LOCATION = "Z:"+"\\"+"Electromechanics"+"\\"+"Projects"+"\\"+"chargesensor"+"\\"+"backups"+"\\"+"Raw_data"+"\\"+'CD12_B5_F4v13_backup.db'
