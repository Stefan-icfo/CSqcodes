...
DATABASE_LOCATION = ".\Data\Raw_data\CD12_B5_F4v7.db"
...
BACKUP_DATABASE_LOCATION = "Z:"+"\\"+"Electromechanics"+"\\"+"Projects"+"\\"+"chargesensor"+"\\"+"backups"+"\\"+"Raw_data"+"\\"+'CD12_B5_F4v7_backup.db'
