...
# Example: 6 -> 99.999993%
fidelity_decimals = 13

# ------------------ integration groups (YOUR NEW SCHEME) ------------------
# Runs start at 241.
# Every 10 runs integration time changes.
# Starts at 100 ns and every 10 runs increases by 150 ns.
# Up to 851–860 which corresponds to 9.25 us (9250 ns).
...
# optional: quick sanity check that last full block is the one you expect
# (if you ever change end_run, this might not be true anymore)
