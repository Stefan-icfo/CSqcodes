...
# Database location
#if commented out, current database
qc.config["core"]["db_location"] = "C:\\" + "Users\\" + "LAB-nanooptomechanic\\" + "Documents\\" + "MartaStefan\\" + "CSqcodes\\" + "Data\\" + "Raw_data\\" + "CD12_B5_F4v30_14_11_25.db"

experiments = qc.experiments()

# Load datasets
dataset1 = qc.load_by_id(959)
dataset2 = qc.load_by_id(956)
...
G1_raw = pdf_temp1['signal_shift_Vx_deriv_trc']
G2_raw = pdf_temp2['signal_shift_Vx_deriv_trc']
...
x1_raw = data_xy1[param_name]['QDAC_ch03_dc_constant_V']
y1_raw = data_xy1[param_name]['QDAC_ch02_dc_constant_V']
x2_raw = data_xy2[param_name]['QDAC_ch03_dc_constant_V']
