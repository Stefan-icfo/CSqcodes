...
run_ids2=[540,553,566,579,595,609,647,661,673,682,691,700,709,721,747,756]#in dbv1171025
...
if e_nr==True:
    ...
    errors_scaled = np.array(sensitivities2) * np.array(L_errors) / (2 * np.sqrt(areas2))
