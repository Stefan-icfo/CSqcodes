...
#X:\Electromechanics\Projects\chargesensor\backups\Raw_data
qc.config["core"]["db_location"]="X:"+"\\"+"Electromechanics"+"\\"+"Projects"+"\\"+"chargesensor"+"\\"+"backups"+"\\"+"Raw_data"+"\\"+'CD11_D7_C1.db'
