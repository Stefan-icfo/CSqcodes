...
class MyZurich(ziqc.UHFLI):
    ...
    def __init__(self, manual_instr, *args, **kwargs):
        ...
        source.add_parameter('demod_R',
                             label='demod_R',
                             unit='V',
                             docstring='Demodulated value of R',
                             get_cmd=self._get_R,
                             get_parser=float,
                             set_cmd=False,
                             )  

        source.add_parameter('demod_complex',
                             label='demod_complex',
                             unit='V',
                             docstring='Complex demodulated value',
                             get_cmd=self._get_demod_complex,
                             get_parser=complex,
                             set_cmd=False,
                             )  
        ...
        source.add_parameter('conductance_Ithaco',
                             label='conductance',
                             unit='S',
                             docstring='Conductance of the channel',
                             get_cmd=self._get_conductance_Ithaco,
                             get_parser=complex,
                             set_cmd=False,
                             )
        source.add_parameter('resistance_Ithaco',
                             label='resistance',
                             unit='Ohm',
                             docstring='Resistance of the channel',
                             get_cmd=self._get_resistance_Ithaco,
                             get_parser=complex,
                             set_cmd=False,
                             )
