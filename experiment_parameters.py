...
#used params
start_vg_cs=0.95#0.955#0.905#0.870#0.783#0.803#1.12 #0.960
stop_vg_cs =0.97#0.975#0.910#0.875#11#1.17#0.970
step_num_cs=20*50#1000*5#10*100
#saved old
...
start_f =140e6#141.4e6#141.6e6#150.5e6#150e6#159.1e6 #Hz unit #438e6#
stop_f =  144e6#142.2e6#142.1e6#151.5e6#160e6#159.3e6 #Hz unit #442e6#
step_num_f =2000#160*4#300*4#500*4#80*100#10000*4 #4000#
#step_num_f=round((stop_f-start_f)/250)
freq_sweep_avg_num=21


#linesweep
start_vgo_ls=-4.1#-1.88
stop_vgo_ls=4.1#-1.68
step_vgo_num_ls=820*4#5002mV
start_vgi_ls= 0.75#0.920
stop_vgi_ls= 1#0.970
step_vgi_num_ls=250*10
