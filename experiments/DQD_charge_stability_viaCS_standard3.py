...
#####################
start_vg1 = -2.164#-1.934#
stop_vg1 = -2.156#-1.929 #delta 15
step_vg1_num =8*10#10uv
...
step_vg2_num=30*20#5uV
step_vg2=np.absolute((start_vg2-stop_vg2)/step_vg2_num)
vars_to_save.append(step_vg2)

start_vgcs=-1.239#0.0372 #-0lowerV slope, 140nS
#GVg params
step_cs_num=60*40#20uV
delta=20e-3#10mV
