...
from utils.CS_utils import breit_wigner_fkt, idt_perpendicular_angle, make_detuning_axis, zurich_phase_voltage_current_conductance_compensate
import os
...
idt_point1_x=-1.18391
idt_point1_y=-1.26927
idt_point2_x=-1.18029
idt_point2_y=-1.26717
delta=1000e-6

start_vgo2,start_vgo1,stop_vgo2,stop_vgo1=make_detuning_axis(idt_point1_x,idt_point1_y,idt_point2_x,idt_point2_y,delta) 


postfix = f" g1={round(qdac.ch01.dc_constant_V(),2)},g3={round(qdac.ch03.dc_constant_V(),2)},g5={round(qdac.ch05.dc_constant_V(),2)}"
step_vgo_num=1 #sqrt(100^2+200^2)uV
...
stop_vgi = -1.454#-0.776
step_vgi_num = 3*40+1#50uV
