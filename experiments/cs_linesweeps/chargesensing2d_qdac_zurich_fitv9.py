...
idt_point1_x=-2.06579
idt_point1_y=-2.07196
idt_point2_x=-2.06446
idt_point2_y=-2.07079
delta=300e-6
xi=0#move along ict (take traces not through centerbut closer to  triple pt)
epsilon_0=-50e-6#move prependicular to ict (compensate for drift)
...
#####################
start_vgi = -2.224#-0.788
stop_vgi = -2.221#-0.776
step_vgi_num = 3*40
#40uV
...
initial_guess = [-2.222, 1e-4, 1e-6]#initial guess for peakV, Gamma,height for first GVg
