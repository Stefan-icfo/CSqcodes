...
print("preramping")
qdac.ramp_multi_ch_slowly([qdac.ch02,qdac.ch04,qdac.ch06],[start_vgo1,start_vgo2,start_vgi])
...
meas.register_custom_parameter('I_sens', 'I_sens', unit='A', basis=[], setpoints=[delta_param,inner_gate_sweep.parameter])
