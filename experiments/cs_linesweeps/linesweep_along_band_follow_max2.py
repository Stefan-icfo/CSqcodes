...
postfix = 'fluctuating_base_trynafindictwithgoodcbpeak'
...
#####################
start_vgi = qdac.ch06.dc_constant_V()-2e-3-50e-3#-0.788
stop_vgi = - qdac.ch06.dc_constant_V()-2e+3-100e-3#-0.776
step_vgi_num = 150*10#20uV
#step_vgi_num = round((stop_vgi-start_vgi)/vsd*upper_bound_lever_arm)
#print(f"step i num={step_vgi_num}")
step_vgi=np.absolute((start_vgi-stop_vgi)/step_vgi_num)

start_vgi_scan=qdac.ch06.dc_constant_V()-2e-3#first guess for peak
scan_range=4e-3
