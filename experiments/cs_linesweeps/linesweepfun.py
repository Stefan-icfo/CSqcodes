...
xilist=[0,-0.2,0.2,-0.1,0.1,-0.3,0.3]
eps=600e-6
#for xi in xilist:
#    delta_fit_fun(xi,eps)


def delta_fit_fun(xi=0,epsilon_0=500e-6,Temp=500):
    ...
    prefix_name = f'{Temp}mK,xi={xi}epslion={epsilon_0*1e6},__'#
    ...
    step_vgo_num=240 #sqrt(100^2+200^2)uV
    ...
    #####################
    start_vgi = -1.4555#-0.788

    stop_vgi = -1.4525#-0.776
