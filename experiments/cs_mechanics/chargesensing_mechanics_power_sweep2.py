...
#####################
start_vgi =-2.233# -0.8335
stop_vgi = -2.231#-0.8315
step_vgi_num= 2*100#2*100
...
#####################
start_f = 401.88e6#275.05e6 #Hz unit
stop_f =  401.96e6#275.20e6 #Hz unit
step_num_f = 8*10*5#15*200+1 #
