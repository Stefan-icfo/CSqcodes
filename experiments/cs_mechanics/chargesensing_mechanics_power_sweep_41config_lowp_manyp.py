...
instr_power_sweep=[20e-6,20e-6,10e-6,10e-6,6e-6,3e-6,3e-6,2e-6,2e-6,1e-6,1e-6]
...
initial_guess = [-1.229, 1e-4, 3e-6]#initial guess for peakV, Gamma,height for first GVg
sitfraction=0.65#where to sit on Coulomb peak. For now on left side

vars_to_save.extend([start_vgi,stop_vgi,step_vgi_num])
#####################
start_f = 121.891e6#122e6 #Hz unit
stop_f = 121.895e6# 121.94e6 #Hz unit
step_num_f = 4*500#1 #50Hz
