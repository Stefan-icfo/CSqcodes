...
prefix_name = 'cs_mechg2drive_lslope'#
postfix = '700mK'
...
outer_gates=[qdac.ch01.dc_constant_V,qdac.ch02.dc_constant_V,qdac.ch03.dc_constant_V]
...
with meas.run() as datasaver:
    ...
    with meas_aux.run() as datasaver_aux:
        ...
        for outer_gate_value in tqdm(outer_gates_sweep, leave=False, desc='outer Gate Sweep', colour = 'green'): #slow axis loop (gate)
            ...
            for gate in outer_other_gates:
                gate(outer_gate_value+others_offset)
