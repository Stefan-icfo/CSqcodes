...
prefix_name = '_k2400_chargesensing_getleverarm_ofg23'
#prefix_name = 'test'
postfix = 'no_postfix'
...
print('wait time')
#time.sleep(10)
sleeptime=max(abs(start_vgo-outer_gate()),abs(start_vgo-outer_auxgate1()),abs(start_vgo-outer_auxgate2()),abs(start_vgi-inner_gate()))/gate_ramp_speed/1000+20
print(sleeptime)
