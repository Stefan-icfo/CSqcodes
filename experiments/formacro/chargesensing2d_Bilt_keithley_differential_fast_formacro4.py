...
prefix_name = '_k2400_chargesensing_confinedotongate123_leverarmgate1only'
#prefix_name = 'test'
postfix = 'no_postfix'
...
vsdkT=Temp/11604
vsd=1.5*vsdkT
print(f"vsd1.5*kT={vsd}V. ABORT NOW IF FUNKY. u got 10 seconds")
time.sleep(10)
...
#swept contacts
outer_gate=bilt.ch04.v  # swept gate voltage
outer_auxgate1=bilt.ch01.v
blockade_gate=bilt.ch02.v
inner_gate=bilt.ch03.v
source = k2400 #swept source voltag
...
print('wait time')
#time.sleep(10)
sleeptime=max(abs(start_vgo-outer_gate()),abs(start_vgo-outer_auxgate1()),abs(3-blockade_gate()),abs(start_vgi-inner_gate()))/gate_ramp_speed/1000+20
print(sleeptime)
