...
prefix_name = '_k2400_chargesensing_zoomtransition_modulatingonlyg23_withg45andg1at+1'
#prefix_name = 'test'
postfix = 'no_postfix'
...
print('wait time')
#time.sleep(10)
sleeptime=max(abs(start_vgo-outer_gate()),abs(1-outer_auxgate1()),abs(1-outer_auxgate2()),abs(start_vgi-inner_gate()))/gate_ramp_speed/1000+200
print(sleeptime)
