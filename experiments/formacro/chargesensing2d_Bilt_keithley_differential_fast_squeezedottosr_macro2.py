...
prefix_name = '_k2400_chargesensing_g1+1g450V'
#prefix_name = 'test'
postfix = 'no_postfix'
...
print('wait time')
#time.sleep(10)
sleeptime=max(abs(start_vgo-outer_gate()),abs(1-outer_auxgate1()),abs(0-outer_auxgate2()),abs(start_vgi-inner_gate()))/gate_ramp_speed/1000+200
print(sleeptime)
