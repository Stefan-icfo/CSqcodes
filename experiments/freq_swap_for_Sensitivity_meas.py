...
probe_frequency=freq_rf()
mode_frequency=probe_frequency+1.25e6
print(f"frf is{probe_frequency}")
random_frequency=mode_frequency+1e4
exp_name=f"freq_swap@instr100mKmode{mode_frequency}rand{random_frequency}avg{nr_avg}"
        ...
        for burst_idx in range(nr_burst):
            ...
            # Read data from the DAQ
                ...
                if burst_idx % 2==0: 
                    ...
                    freq_mech(mode_frequency)
                    freq_rf(mode_frequency-f_rlc)
                    ...
                    print("off")
                    freq_mech(random_frequency)
                    freq_rf(random_frequency-f_rlc)
                    current_time=time.time()-start_time
