...
def run_thermomech_temp_meas2(reps_nodrive=reps_nodrive):
    ...
    slope,sitpos=do_GVg_and_adjust_sitpos(testplot=True,sitfraction=0.9)
    ...
    exp_name="1dot_nodrive_spectrum_uponpeak"
...
#temp_meas_180mK=CSExperiment()\
        ...
        temp_meas_100mK_3.area_values_scaled_by_slope.append(area_under_lorentzian/slope)
        temp_meas_100mK_3.area_values_unscaled.append(area_under_lorentzian)
        temp_meas_100mK_3.slopes.append(slope)


for n in range(5):
   # do_GVg_and_adjust_sitpos()
    run_thermomech_temp_meas2()
    print(f"done round {n}")
    time.sleep(20)
    #print(n)

#do_GVg_and_adjust_sitpos()
run_thermomech_temp_meas2(reps_nodrive=100)
    #if n==10:
