...
time.sleep(5)
#weet_CS_spot=qdac.ch06.dc_constant_V()
#exp.GVG_fun_sensitivity(start_vg=-1.35,stop_vg=-1.26,step_num=90*20,costum_prefix='RF_5g@leftsingleholedot_75mV@gateinstr_100MHz',mod_frequency=1e8,mod_amplitude=75e-3,drive_type='RF')
#exp.GVG_fun_sensitivity(start_vg=-1.35,stop_vg=-1.26,step_num=90*20,costum_prefix='RF_5g@leftsingleholedot_50uV@gateinstr_mechres',mod_frequency=mode_freq,mod_amplitude=50e-6,drive_type='RF')
#exp.GVG_fun_sensitivity(start_vg=-1.35,stop_vg=-1.26,step_num=90*20,costum_prefix='RF_5g@leftsingleholedot_500uV@gateinstr_mechres',mod_frequency=mode_freq,mod_amplitude=500e-6,drive_type='RF')
#exp.GVG_fun_sensitivity(start_vg=-1.35,stop_vg=-1.26,step_num=90*20,costum_prefix='LF_5g@leftsingleholedot_100uV@gateinstr_1kHz',mod_frequency=1e3,mod_amplitude=100e-6,drive_type='LF')
...
BURST_DURATION =1.193#0.569523# 4.772 2.386#
